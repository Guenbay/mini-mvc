...
//$classname = "AutoApp\\Controller\TestDatei";
//$test = new $classname;
...
$controllerClassName = "\\AutoApp\\Controller\\".$controllerName."Controller";
...
try {
    ...
    $view = new AutoApp\Library\View3(__DIR__.DIRECTORY_SEPARATOR."views", $_GET['controller'], $_GET['action']);
    $view->render();
